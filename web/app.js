...
$('#new-campaign').onclick=()=>{createReady();$('#campaign-form').classList.remove('hidden');$('#campaign-list').classList.add('hidden')};
...
$('#create-form').onsubmit=async event=>{
  ...
  }catch(e){if(succeeded){notice(`Campaign submitted, but the dashboard could not refresh: ${e.message}`,true)}else{notice(e.message,true);createReady(`Submission failed: ${e.message} Correct the form and try again.`)}}
